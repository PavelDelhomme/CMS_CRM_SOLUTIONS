    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-600 text-lg">Aucun template disponible pour le moment.</p>
            <p className="text-gray-500 mt-2">Revenez bientôt pour découvrir nos nouveaux designs !</p>
          </div>
        ) : (
        ...
        <div className="mt-20 bg-blue-50 rounded-xl p-8">
          <h3 className="text-2xl font-bold text-gray-900 mb-4">Comment choisir votre template ?</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-semibold text-gray-900 mb-2">Templates Gratuits</h4>
              <p className="text-gray-600">
                Parfaits pour démarrer. Tous les templates de base sont disponibles gratuitement avec tous les plans.
              </p>
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 mb-2">Templates Premium</h4>
              <p className="text-gray-600">

                    ...
                    return (
                      <div key={varName} className="border border-gray-200 rounded-lg p-4">
                        <h5 className="text-sm font-semibold text-gray-900 mb-3">
                          Variable: <code className="bg-gray-100 px-2 py-1 rounded">{'{' + '{' + varName + '}' + '}'}</code>
                        </h5>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                ...
                {detectedVariables.length === 0 && (
                  <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 text-center">
                    ...
                    <p className="text-xs text-gray-500">
                      Pour ajouter des variables, utilisez la syntaxe <code className="bg-white px-2 py-1 rounded border">{'{{nom_variable}}'}</code> dans votre HTML ou CSS.
                    </p>
                    <div className="mt-4 text-left bg-white border border-gray-200 rounded p-3 text-xs font-mono">
                      <p className="text-gray-700 mb-1">Exemples:</p>
                      <p className="text-gray-600">{'<h1>{{company_name}}</h1>'}</p>
                      <p className="text-gray-600">{'<img src="{{logo_url}}" alt="Logo">'}</p>
                      <p className="text-gray-600">{'color: {{primary_color}};'}</p>
                    </div>
                  </div>
                )}
              </div>

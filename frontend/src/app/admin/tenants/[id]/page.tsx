            ...
            <div className="flex items-center justify-between">
              <div>
                <button
                  ...
                  className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:text-gray-100 mb-2 flex items-center"
                >
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">{tenant.email}</p>
              </div>

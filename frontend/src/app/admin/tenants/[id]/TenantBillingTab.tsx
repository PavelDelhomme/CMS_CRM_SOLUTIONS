  ...
  const handleCreateSubscription = async () => {
    ...
    try {
      await billingService.createSubscription({
        tenant_id: tenantId,
        plan_id: parseInt(newSubscriptionData.plan_id),
      ...
      <div className="bg-white shadow rounded-lg p-6">
        <div className="flex items-center justify-center py-12">
          <div className="text-center">
            ...
            <p className="text-gray-600">Chargement des données de facturation...</p>
          </div>
        </div>
      </div>
    )
        ...
        <div>
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">Gérez les abonnements de {tenantName}</p>
            </div>
            <button
          ...
          {subscriptions.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-gray-600 mb-4">Aucun abonnement trouvé pour ce tenant</p>
              <button
                onClick={() => setShowNewSubscriptionModal(true)}
      ...
      {activeSubTab === 'invoices' && (
        <div>
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-600 mt-1">Toutes les factures de {tenantName}</p>
          </div>

          {invoices.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-gray-600">Aucune facture trouvée pour ce tenant</p>
            </div>
          ) : (
            <ResponsiveTable
      ...
      {activeSubTab === 'payments' && (
        <div>
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-600 mt-1">Historique des paiements de {tenantName}</p>
          </div>

          {payments.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-gray-600">Aucun paiement trouvé pour ce tenant</p>
            </div>
          ) : (
            <ResponsiveTable
          ...
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                />
                <label htmlFor="start_trial" className="ml-2 block text-sm text-gray-700">

    ...
    >
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-6">Informations de l'Abonnement</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Tenant Info */}
            <div>
              <h3 className="text-sm font-medium text-gray-500 mb-2">Tenant</h3>
              <p className="text-lg font-semibold text-gray-900">{subscription.tenant?.name || '-'}</p>
              <p className="text-sm text-gray-600">{subscription.tenant?.email || '-'}</p>
              <button
            ...
            {/* Plan Info */}
            <div>
              <h3 className="text-sm font-medium text-gray-500 mb-2">Plan & Niveau de Service</h3>
            ...
            {/* Status & Cycle */}
            <div>
              <h3 className="text-sm font-medium text-gray-500 mb-2">Statut & Cycle</h3>
            ...
            {/* Period Dates */}
            <div>
              <h3 className="text-sm font-medium text-gray-500 mb-2">Période Actuelle</h3>
            ...
            {summary && (
              <div>
                <h3 className="text-sm font-medium text-gray-500 mb-2">Résumé Financier</h3>
                <div className="space-y-1 text-sm">
                  <div className="flex justify-between">
                    <span className="text-gray-600">Total facturé:</span>
                    <span className="font-semibold text-gray-900">{formatCurrency(summary.total_invoiced || 0)}</span>
                  </div>
                  <div className="flex justify-between">
            ...
            <div>
              <h3 className="text-sm font-medium text-gray-500 mb-2">Factures & Paiements</h3>
              <div className="space-y-1 text-sm">
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            <h2 className="text-lg font-semibold text-gray-900">Factures ({invoices.length})</h2>
          </div>
          <ResponsiveTable
        ...
        {payments.length > 0 && (
          <div className="bg-white rounded-lg shadow overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200">
              <h2 className="text-lg font-semibold text-gray-900">Paiements ({payments.length})</h2>
            </div>
            <ResponsiveTable

  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row gap-6 h-full">
        ...
        <div className="lg:w-1/4 bg-white rounded-lg shadow p-6 space-y-6 overflow-y-auto">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Paramètres SEO</h2>
          ...
          <div className="border-t pt-4">
            ...
            <p className="text-xs text-gray-500">
              La page d'accueil publique sera visible sur <code className="bg-gray-100 px-1 rounded">localhost:9494/</code>
            </p>
          </div>
        </div>

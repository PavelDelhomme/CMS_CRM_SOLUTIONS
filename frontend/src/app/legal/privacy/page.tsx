        ...
        <div className="prose prose-lg max-w-none">
          <div className="bg-white rounded-xl shadow-lg p-8 space-y-8">
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">2.1. Données que vous nous fournissez</h3>
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">2.2. Données collectées automatiquement</h3>
              <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">

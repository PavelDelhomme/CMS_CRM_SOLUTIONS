      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="prose prose-lg max-w-none">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 space-y-8">
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">1. Introduction</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">2. Données collectées</h2>
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-3">2.1. Données que vous nous fournissez</h3>
              <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 dark:text-gray-300 space-y-2 ml-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-3 mt-6">2.2. Données collectées automatiquement</h3>
              <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 dark:text-gray-300 space-y-2 ml-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">3. Utilisation des données</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">4. Base légale du traitement</h2>
              <p className="text-gray-700 dark:text-gray-300 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">5. Partage des données</h2>
              <p className="text-gray-700 dark:text-gray-300 dark:text-gray-300 leading-relaxed mb-4">
              ...
              <p className="text-gray-700 dark:text-gray-300 dark:text-gray-300 leading-relaxed mt-4">
                Tous nos prestataires sont tenus de respecter la confidentialité de vos données et sont conformes au RGPD.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">6. Conservation des données</h2>
              <p className="text-gray-700 dark:text-gray-300 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">7. Vos droits</h2>
              <p className="text-gray-700 dark:text-gray-300 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">8. Cookies</h2>
              <p className="text-gray-700 dark:text-gray-300 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">9. Sécurité</h2>
              <p className="text-gray-700 dark:text-gray-300 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">10. Transferts internationaux</h2>
              <p className="text-gray-700 dark:text-gray-300 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">11. Modifications</h2>
              <p className="text-gray-700 dark:text-gray-300 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">12. Contact</h2>
              <p className="text-gray-700 dark:text-gray-300 dark:text-gray-300 leading-relaxed mb-4">

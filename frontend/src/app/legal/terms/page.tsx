      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="prose prose-lg max-w-none">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 space-y-8">
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">1. Objet</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">2. Services proposés</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">3. Tarifs et modalités de paiement</h2>
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-3">3.1. Tarifs</h3>
              <p className="text-gray-700 dark:text-gray-300 dark:text-gray-300 leading-relaxed">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-3 mt-6">3.2. Période d'essai</h3>
              <p className="text-gray-700 dark:text-gray-300 dark:text-gray-300 leading-relaxed">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-3 mt-6">3.3. Paiement</h3>
              <p className="text-gray-700 dark:text-gray-300 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">4. Obligations du Client</h2>
              <p className="text-gray-700 dark:text-gray-300 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">5. Obligations de VTCBuilder</h2>
              <p className="text-gray-700 dark:text-gray-300 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">6. Résiliation</h2>
              <p className="text-gray-700 dark:text-gray-300 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">7. Propriété intellectuelle</h2>
              <p className="text-gray-700 dark:text-gray-300 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">8. Protection des données</h2>
              <p className="text-gray-700 dark:text-gray-300 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">9. Responsabilité</h2>
              <p className="text-gray-700 dark:text-gray-300 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">10. Droit applicable et juridiction</h2>
              <p className="text-gray-700 dark:text-gray-300 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">11. Contact</h2>
              <p className="text-gray-700 dark:text-gray-300 dark:text-gray-300 leading-relaxed">

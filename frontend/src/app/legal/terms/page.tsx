        ...
        <div className="prose prose-lg max-w-none">
          <div className="bg-white rounded-xl shadow-lg p-8 space-y-8">
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">3.1. Tarifs</h3>
              <p className="text-gray-700 leading-relaxed">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">3.2. Période d'essai</h3>
              <p className="text-gray-700 leading-relaxed">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">3.3. Paiement</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">4. Obligations du Client</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">5. Obligations de VTCBuilder</h2>
              <p className="text-gray-700 leading-relaxed mb-4">

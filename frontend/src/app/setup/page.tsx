    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Compte configuré avec succès !</h1>
          <p className="text-gray-600 mb-6">Votre compte est maintenant actif. Redirection vers votre dashboard...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">{error || 'Ce lien d\'invitation est invalide ou a expiré.'}</p>
          <button
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Configurer votre compte</h1>
          {tenant && (
            <p className="text-gray-600">
              Bienvenue sur <strong>{tenant.name}</strong>
            </p>
          )}
          <p className="text-sm text-gray-500 mt-2">Définissez votre mot de passe pour commencer</p>
        </div>

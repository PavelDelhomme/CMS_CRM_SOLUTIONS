      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-500 mb-1">Point de départ</label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4 border-t">
              <div>
                <label className="block text-sm font-medium text-gray-500 mb-1">Date/Heure</label>
                <p className="text-gray-900">{formatDate(booking.pickup_datetime)}</p>
              </div>
              {booking.estimated_distance && (
                <div>
                  <label className="block text-sm font-medium text-gray-500 mb-1">Distance</label>
                  <p className="text-gray-900">{booking.estimated_distance} km</p>
                </div>
              )}
              {booking.estimated_duration && (
                <div>
                  <label className="block text-sm font-medium text-gray-500 mb-1">Durée estimée</label>
                  <p className="text-gray-900">~{booking.estimated_duration} min</p>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-500 mb-1">Prix estimé</label>
            ...
            {booking.final_price && (
              <div>
                <label className="block text-sm font-medium text-gray-500 mb-1">Prix final</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-500 mb-1">Statut paiement</label>
              ...
              {booking.payment_method && (
                <p className="text-xs text-gray-500 mt-1">Méthode: {booking.payment_method}</p>
              )}
            </div>
          </div>
        </div>

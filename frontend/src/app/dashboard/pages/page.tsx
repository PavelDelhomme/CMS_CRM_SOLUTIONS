    ...
    >
        {pages.length === 0 ? (
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-12 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-2">Aucune page</h3>
            <p className="text-gray-500 dark:text-gray-400 dark:text-gray-400 mb-6">Commencez par créer votre première page.</p>
            <button
              onClick={() => router.push('/dashboard/pages/new')}
              className="btn btn-primary"
            >
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3">
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 dark:text-gray-100">{page.title}</h3>
                    ...
                    {page.meta_description && (
                      <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400 mt-2">{page.meta_description}</p>
                    )}
                  </div>

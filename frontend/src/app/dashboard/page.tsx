  ...
  return (
    ...
    >
      ...
      <div className="mb-6 lg:mb-8">
        <h2 className="text-xl lg:text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4 lg:mb-6">Actions Rapides</h2>
      ...
      <div>
        <h2 className="text-xl lg:text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4 lg:mb-6">Autres Sections</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
          {menuItems.map((item, index) => (
            <button
              key={index}
              onClick={() => router.push(item.href)}
              className="group bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-all duration-200 p-5 lg:p-6 text-left"
            >
              <div className="flex items-center gap-4">
                <div className={`text-3xl lg:text-4xl ${item.color} p-3 rounded-xl group-hover:scale-110 transition-transform duration-200`}>
                  {item.icon}
                </div>
                <div className="flex-1 min-w-0">
                  <h3 className="text-base lg:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-1">{item.title}</h3>
                  <p className="text-xs lg:text-sm text-gray-600 dark:text-gray-400 truncate">{item.description}</p>
                </div>
              </div>
            </button>
          ))}

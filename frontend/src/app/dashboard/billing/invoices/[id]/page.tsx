        ...
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-4xl mx-auto">
          ...
          <div className="flex justify-between items-start mb-8 pb-8 border-b">
            <div>
              ...
              <p className="text-gray-600">VTCBuilder</p>
            </div>
            <div className="text-right">
              <p className="text-lg font-semibold text-gray-900">N° {invoice.invoice_number}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div>
              <h2 className="text-sm font-semibold text-gray-500 uppercase mb-4">Informations Client</h2>
            ...
            <div>
              <h2 className="text-sm font-semibold text-gray-500 uppercase mb-4">Détails de la facture</h2>
            ...
            <table className="w-full">
              ...
              <tbody>
                <tr className="border-b border-gray-200">
                  ...
                  <td className="py-4 px-4 text-right text-gray-900">{invoice.subtotal.toFixed(2)} {invoice.currency}</td>
                  <td className="py-4 px-4 text-right text-gray-900">{invoice.tax.toFixed(2)} {invoice.currency}</td>
                  <td className="py-4 px-4 text-right font-semibold text-gray-900">{invoice.total.toFixed(2)} {invoice.currency}</td>
                </tr>
              </tbody>
              <tfoot>
                <tr>
                  <td colSpan={3} className="py-4 px-4 text-right font-semibold text-gray-900">Total TTC:</td>
                  <td className="py-4 px-4 text-right text-xl font-bold text-gray-900">{invoice.total.toFixed(2)} {invoice.currency}</td>
                </tr>
              </tfoot>
            </table>
          </div>

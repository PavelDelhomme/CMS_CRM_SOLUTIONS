...
class TestTenantModel:
    ...
    def test_tenant_is_active(self):
        ...
        inactive_tenant = Client.objects.create(
    ...
    def test_tenant_is_trial(self):
        ...
        trial_tenant = Client.objects.create(
            name='Trial Tenant',
    ...
    def test_tenant_soft_delete(self):
        ...
        assert Client.objects.filter(deleted_at__isnull=False, id=tenant_id).exists()
...
class TestUserModel:
    ...
    def test_user_is_active(self):
        """Test is_active property"""
        tenant = Client.objects.create(name='Test', email='test@test.com', slug='test')

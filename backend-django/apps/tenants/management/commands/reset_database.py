...
from apps.billing.models import Subscription, Invoice, Payment, PricingPlan
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            tenant_schemas = list(Client.objects.values_list('schema_name', flat=True))
            tenant_table = Client._meta.db_table
